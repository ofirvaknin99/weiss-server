...
var ExternalApiRouter = /** @class */ (function () {
    ...
    ExternalApiRouter.getMedias = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                allMediasReq = [];
                axios_1.default.get("".concat(config_1.fullImdbUrl, "&s=").concat(req.params.mediaName))
                    .then(function (mediasResponse) {
                    var _a = mediasResponse.data, Search = _a.Search, totalResults = _a.totalResults, Response = _a.Response;
                    if (Response === 'True' && totalResults > 10) {
                        allMediasReq = ExternalApiRouter.createGetAllmediasReq(totalResults, req.params.mediaName);
                        Promise.all(allMediasReq).then(function (medias) {
                            medias.filter(function (mediaResponse) {
                                Search = __spreadArray(__spreadArray([], Search, true), mediaResponse.data.Search, true);
                            });
                            res.send(Search);
                        });
                    }
